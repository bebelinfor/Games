...
import prova.web.snoopygame.databinding.ActivityJogadorBinding
...
class JogadorActivity : AppCompatActivity() {
    ...
    fun buttonClick(view: View) {
        ...
        if(jogadorAtual.equals("Snoopy")) {
            buttonSelecionado.setBackgroundResource(R.drawable.snoopy)
            jogadorAtual = "Peanuts"
        }else{
            buttonSelecionado.setBackgroundResource(R.drawable.peanuts)
            jogadorAtual = "Snoopy"
        }
